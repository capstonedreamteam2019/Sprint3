...
public partial class MasterPage : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        getMess.CommandText = "Select count(MessageID) From Messages1 where(HasSeen = '*')";
    ...
    {
        dt = new DataTable();
        SqlCommand cmd = new SqlCommand("SELECT * FROM Messages1 inner JOIN Users ON Users.UserID = Messages1.MessageFromID  inner JOIN SchoolEmployee ON SchoolEmployee.UserID = Users.UserID inner JOIN School ON SchoolEmployee.SchoolID = School.SchoolID where(HasSeen = '*')", localDB);
